...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-BWnAEnue.js';
...
const lang_map = {
  python: () => import('./index32-C9mea60r.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-CW7WmoT5.js'),
      import('./frontmatter-B9k53Ai-.js')
    ]);
  ...
  json: () => import('./index37-DZQhNbPW.js').then((m) => m.json()),
  html: () => import('./index34-BvOi9mDT.js').then((m) => m.html()),
  css: () => import('./index35-BVlgRFYW.js').then((m) => m.css()),
  javascript: () => import('./index36-B8gb9e2S.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-B8gb9e2S.js').then(
...
//# sourceMappingURL=Index15-H6zfYE4-.js.map
