...
const name$m = "decalVertexDeclaration";
const shader$m = `#ifdef DECAL
...
const name$l = "uvAttributeDeclaration";
const shader$l = `#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;
...
const name$k = "bonesDeclaration";
const shader$k = `#if NUM_BONE_INFLUENCERS>0
...
const name$j = "bakedVertexAnimationDeclaration";
const shader$j = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
const name$i = "instancesDeclaration";
const shader$i = `#ifdef INSTANCES
...
const name$h = "prePassVertexDeclaration";
const shader$h = `#ifdef PREPASS
...
const name$g = "samplerVertexDeclaration";
const shader$g = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
const name$f = "bumpVertexDeclaration";
const shader$f = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
const name$e = "lightVxFragmentDeclaration";
const shader$e = `#ifdef LIGHT{X}
...
const name$d = "lightVxUboDeclaration";
...
const name$c = "morphTargetsVertexGlobalDeclaration";
const shader$c = `#ifdef MORPHTARGETS
...
#endif
`;
if (!ShaderStore.IncludesShadersStore[name$c]) {
  ShaderStore.IncludesShadersStore[name$c] = shader$c;
}
const name$b = "morphTargetsVertexDeclaration";
const shader$b = `#ifdef MORPHTARGETS
...
const name$a = "morphTargetsVertexGlobal";
const shader$a = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
...
const name$9 = "morphTargetsVertex";
...
const name$8 = "instancesVertex";
const shader$8 = `#ifdef INSTANCES
...
const name$7 = "bonesVertex";
const shader$7 = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
const name$6 = "bakedVertexAnimation";
const shader$6 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
const name$5 = "prePassVertex";
const shader$5 = `#ifdef PREPASS_DEPTH
...
const name$4 = "uvVariableDeclaration";
const shader$4 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
const name$3 = "samplerVertexImplementation";
...
const name$2 = "bumpVertex";
const shader$2 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
const name$1 = "shadowsVertex";
const shader$1 = `#ifdef SHADOWS
